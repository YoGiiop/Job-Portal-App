...
export const RecruiterDashboard = () => {
    ...
    //                     // const response = await fetch(`${process.env.REACT_APP_API_URL}/jobs/all-jobs/${recruiter.jobID}`)
    ...
    //         try {
    //             const reponse = await fetch(`${process.env.REACT_APP_API_URL}/recruiter/all-recruiter`)
    ...
    useEffect(() => {
        if (recruiter && recruiter.jobID) {
            ...
            const fetchJobsData = async () => {
                try {
                    //       const response = await fetch(`${process.env.REACT_APP_API_URL}/jobs/current-jobs/${recruiter.jobID}`);
                    //       const data = await response.json();
                    //       setJobs(data);
